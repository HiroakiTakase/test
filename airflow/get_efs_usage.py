...
# Resource 編集しないでください
RESOURCES_CONFIG = {
  "S": {'request_cpu': '0.5', 'request_memory': '1Gi', 'limit_cpu': '3.0', 'limit_memory': '22Gi'},
  "M": {'request_cpu': '0.5', 'request_memory': '1Gi', 'limit_cpu': '4.0', 'limit_memory': '28Gi'},
  "L": {'request_cpu': '0.5', 'request_memory': '1Gi', 'limit_cpu': '5.0', 'limit_memory': '36Gi'},
}
RESOURCES = RESOURCES_CONFIG[RESOURCES_SIZE]


BASE_DIR = '/home/terrasium/sample_code'
EXECUTION_DATE = '{{ execution_date.in_timezone("Asia/Tokyo").format("YYYYMMDD-hh:mm:ssZ") }}'  # noqa: E501
...
with DAG(
  ...
  start_date=pendulum.datetime(int(START_DATE.split("/")[0]), int(START_DATE.split("/")[1]), int(START_DATE.split("/")[2]), tz="Asia/Tokyo"),
